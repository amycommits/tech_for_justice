...
RSpec.describe "user_case_infos/new", type: :view do
  before(:each) do
    assign(:user_case_info, UserCaseInfo.new(
      :user => nil,
      :docket_id => "MyText",
      :charged_with => "MyText",
      :charge_type => "MyText",
  ...
  it "renders new user_case_info form" do
    render

    assert_select "form[action=?][method=?]", user_case_infos_path, "post" do
